package com.company.entitycustomfield;
...
public class EntitycustomfieldTestContainer extends TestContainer {

    public EntitycustomfieldTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/entitycustomfield/app.properties",
    ...
    public static class Common extends EntitycustomfieldTestContainer {

        public static final EntitycustomfieldTestContainer.Common INSTANCE = new EntitycustomfieldTestContainer.Common();
